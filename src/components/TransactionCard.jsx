        ...
        <div className="glass-card-hover p-4 rounded-xl animate-slide-up hover-lift-sm">
            <div className="flex flex-wrap items-center gap-3">
                ...
                <div className="flex items-center gap-3 flex-1 min-w-0">
                    <div className={`p-2.5 rounded-xl shrink-0 ${type === 'income'
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1.5 text-xs sm:text-sm text-gray-500 dark:text-slate-300 flex-wrap">
                ...
                <div className="flex items-center gap-2 shrink-0 ml-auto">
                    <span className={`text-base sm:text-lg font-bold ${type === 'income'
